    ...
    <div class="body_container">
        ...
        <div id="content" class="content_container">
            <div class="container_inner">
                ...
                <!-- /.사이트 제목 및 메인 영상 영역 -->
                <!-- 방폐장 지도 영역 -->
                <section class="content_section map_wrap">
                    <!-- 지도 네비게이션 영역 -->
                    <div class="navigation_wrap">
                        <!-- 타임라인 -->
                        <div class="_timeline point01">
                            <div class="_inner">
                            ...
                            <ul>
                                <li class="point01 point active">
                                    ...
                                    <p class="_description">
                                        발생지에서 반입된 중저준위 방사성 폐기물의 인수 검사 및 저장을하고 시설 내에서 발생되는 폐기물을 처리합니다.
                                    </p>
                                </li>
                                <li class="point02 point">
                                    <div class="pin">
                                        <!-- PIN 02 -->
                ...
                <!-- /.yesKORAD 최신 영상 및 뉴스리스트 영역 -->
                <!-- 방폐마블 영역 -->
                <section class="content_section marble_wrap">
                    <div class="section_inner">
                        <div class="title_wrap">
                ...
                <!-- /.퀴즈이벤트 영역 -->
                <!-- SNS공유 영역 -->
                <section class="content_section sns_wrap">
